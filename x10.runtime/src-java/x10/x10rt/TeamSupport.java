...
public class TeamSupport {
    ...
    public static void nativeScatterV(int id, int role, int root, Rail<?> src, Rail<?> src_offs, Rail<?> src_counts, 
	                                 Rail<?> dst, int dst_off,  int counts) {
        aboutToDie("nativeScatterV");
    }

    public static void nativeGather(int id, int role, int root, Rail<?> src, int src_offs,
	                                 Rail<?> dst, int dst_off,  int counts) {
        aboutToDie("nativeGather");
    }
    
    public static void nativeGatherV(int id, int role, int root, Rail<?> src, int src_offs, int src_counts,
	                                 Rail<?> dst, Rail<?> dst_offs, Rail<?> dst_counts) {
        aboutToDie("nativeGatherV");
    }

    public static void nativeAllGather(int id, int role, Rail<?> src, int src_offs,
	                                 Rail<?> dst, int dst_off,  int counts) {
        aboutToDie("nativeAllGather");
    }
    
    public static void nativeAllGatherV(int id, int role, Rail<?> src, int src_offs, int src_counts,
	                                 Rail<?> dst, Rail<?> dst_offs, Rail<?> dst_counts) {
        aboutToDie("nativeAllGatherV");
    }
    
    public static void nativeAllToAllV(int id, int role, Rail<?> src, Rail<?> src_offs, Rail<?> src_counts, 
	                                 Rail<?> dst, Rail<?> dst_offs, Rail<?> dst_counts) {
